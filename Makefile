...
install-w311fwg-iso-dir: ${W311FWG_FILES} ${NV_FILES} ${OFFICE_FILES} cirrus-archive rtl8029-archive tcpip.img ie-archive netscape-archive MYSETUP.SHH WINSETUP.BAT
	...
	7z x -y -o${INSTALLISOIMAGE_DIR}/APPS/NC NCDisk3.img
        ...
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK1" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK1"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK2" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK2"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK3" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK3"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK4" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK4"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK5" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK5"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK6" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK6"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK7" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK7"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK8" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK8"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK9" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK9"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK10" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK10"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK11" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK11"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK12" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK12"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK13" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK13"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK14" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK14"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK15" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK15"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK16" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK16"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK17" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK17"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK18" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK18"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK19" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK19"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK20" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK20"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK21" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK21"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK22" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK22"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK23" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK23"
        [ -d "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK24" ] || mkdir "${INSTALLISOIMAGE_DIR}/APPS/MSOFFICE/DISK24"
