...
install-w311fwg-iso-dir: ${W311FWG_FILES} ${NC_FILES} ${OFFICE_FILES} cirrus-archive svga-archive rtl8029-archive tcpip.img pkzip.img ie-archive netscape-archive src/WINSETUP/MYSETUP.SHH src/WINSETUP/WINSETUP.BAT src/WINSETUP/DRIVERS.BAT src/APPS/NC/INSTALL.BAT
	...
	[ -d "${INSTALLISOIMAGE_DIR}/APPS/IE" ] || 7z e -o${INSTALLISOIMAGE_DIR}/APPS/IE ${IE_ARCHIVE} "Microsoft Internet Explorer 5.0 (5.00.0913.2200) [Windows 3.x]/ie5win31.exe"
	...
	[ -d "${INSTALLISOIMAGE_DIR}/APPS/NETSCAPE" ] || 7z x -y -o${INSTALLISOIMAGE_DIR}/APPS/NETSCAPE ${NETSCAPE_ARCHIVE} && mv "${INSTALLISOIMAGE_DIR}/APPS/NETSCAPE/Netscape Composer 4.09SE.exe" "${INSTALLISOIMAGE_DIR}/APPS/NETSCAPE/netscape.exe"
